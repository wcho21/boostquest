...
for i in range(1, 100+1):
  ...
  makeDirIfNotExists('solve_answers/31')
  answer1 = getBoostHash(contents)
  f = open('solve_answers/31/' + fileIndex + '.txt', 'w')
  f.write(answer1)

  makeDirIfNotExists('solve_answers/32')
  answer2 = findNonce(contents)
  f = open('solve_answers/32/' + fileIndex + '.txt', 'w')
  f.write(answer2)
